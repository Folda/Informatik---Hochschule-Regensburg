\begin{acronym}
	...
	\acro{RS}{Reguläre Sprache}
	\acro{gem.}{gemäß}
	\acro{bekanntem.}{bekanntermaßen}
	\acro{reg.}{regulärer}
	\acro{RA}{Reguläre Ausdruck}
	\acro{G-NEA}{generalisierter nicht deterministischer Automat}
	\acro{WS}{Wertsprache}
	\acro{bel.}{beliebige}
	\acro{o.B.d.A}[\ensuremath{\mbox{o.\,B.\,d.\,A}\xspace}]{ohne Beschränkung der Allgemeinheit}
