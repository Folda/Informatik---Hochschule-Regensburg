...
\begin{fbeweis}
Sei $G$ eine reguläre Grammatik. WEnn man die Regeln aus Lemmata 4.4 und 4.5 \Todo{Ref zu Lemma} anwendet, erhält man eine Grammatik $G_0 = \rkl{\Sigma_N, \Sigma_T, P_0, S}$ mit folgenden Eigenschaften.
\begin{enumerate}
\item $L(G_0) = L(G)$
