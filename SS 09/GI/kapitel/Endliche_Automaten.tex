...
Laut \ac{Def.} von $\hat{\delta}_D$ \Todo{Ref to Definition} \ac{bzw.} $\hat{\delta}_N$ gilt:
...
\Mark{Section 3.4}
\Insert{GI-06.05.2009-IMG-1}
Minimieren von Automaten bedeutet
\begin{itemize}
\item entfernen unerreichbarer Zustände \Todo{G und H mit rot durchstreichen in IMG-1}
...
\end{enumerate}
\Insert{GI(U)-07.05.2009-IMG-1}
\Insert{GI(U)-07.05.2009-IMG-2}
\begin{center}
...
\end{tabular}
\end{center}
\Insert{GI(U)-07.05.2009-TAB-3}
\Insert{GI(U)-07.05.2009-IMG-4}
\end{beobachtung}
