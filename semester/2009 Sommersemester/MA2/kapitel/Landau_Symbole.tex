...
\begin{enumerate}
\item \begin{itemize}
		\item Man nennt einen Algorithmus \indexb{effizient} wenn seine Komplexität/Laufzeit im "`worst case"' höchstens polynomial wächst.
		\item Ist die Komplexität im "`worst case"' exponentiell nennt man den Algorithmus \indexb{ineffizient}
...
\item $b_n \ceq \rklamm{1 + \frac{1}{n}}^n + \rklamm{-1 - \frac{1}{n}}^n$
		...
		= &\rkl{1 + \frac{1}{n}}^n \mal \rkl{1 + (-1)^n} = \begin{cases}0 \tx{ für } n \tx{ ungerade}\\2 \underbrace{\rkl{1 + \frac{1}{n}}^n}_{\ural{n \ra \infty} e} \tx{ für } n \tx{ gerade}\end{cases}
		\end{align*}
