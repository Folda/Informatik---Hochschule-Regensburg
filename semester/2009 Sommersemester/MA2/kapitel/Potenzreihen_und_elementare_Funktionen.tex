...
Die (formale) Reihe $\sum_{n = 0}^{\infty} a_n (x - x_0)^n$ heißt \indexb{Potenzreihe} mit Entwicklungspunkt $x_0$ und Koeffizienten $(A_n)_{n \in \N_0}$
\end{fdefinition}
...
Für jede Potenzreihe $\sum_{n = 0}^{\infty} a_n (x - x_0)^n$ existiert ein eindeutig bestimmter \indexb{Konvergenzradius} $r$ ($0 \klgl r \klgl \infty$) für den gilt:
\begin{enumerate}
