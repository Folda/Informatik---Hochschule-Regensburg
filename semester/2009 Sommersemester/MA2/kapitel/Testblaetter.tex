...
\item Die Aussage $a^2 > 0$ ist äquivalent zu:
		\begin{multicols}{2}
		\doublespacing
...
\item Die Aussage $\betrag{a} < b$ ist äquivalent zu:
		\begin{multicols}{2}
		\doublespacing
...
\begin{enumerate}[label=\alph*)]
\item Welche der folgenden Folgen sind beschränkt
		\begin{multicols}{4}
		\doublespacing
...
\item Gilt für zwei Folgen $(A_n)_{n \in \N}$ und $(b_n)_{n \in \N}$ dass $\lim_{n \ra \infty} a_n = \infty$ und $\lim_{n \ra \infty} b_n = \infty$, dann gilt \textbf{möglicherweise} $\lim_{n \ra \infty} (a_n - b_n) = \dots$
		\begin{multicols}{3}
		\doublespacing
...
\item Für die Folge $(a_n)_{n \in \N}$ mit $a_1 = \frac{1}{8}$, $a_{n + 1} \ceq a_n^2 + a_1$ (für $n \in \N$) gilt:
		\begin{multicols}{2}
		\doublespacing
		$\square$\hspace{0.5cm}$(a_n)_{n \in \N}$ ist monoton wachsend\\
		$\square$\hspace{0.5cm}$(a_n)_{n \in \N}$ ist nach oben beschränkt\\
		$\square$\hspace{0.5cm}$(a_n)_{n \in \N}$ ist konvergent\\
		$\square$\hspace{0.5cm}$(a_n)_{n \in \N}$ ist monoton fallend\\
		$\square$\hspace{0.5cm}$(a_n)_{n \in \N}$ ist nach unten beschränkt\\
...
\subsection{Kreuzen Sie ALLE richtigen Antworten an.}
\begin{enumerate}[label=(\alph*)]
\item Wieviele Möglichkeiten gibt es aus den Ziffern 1-8 eine fünfstellige Zahl zu bilden, wenn jede Ziffer nur einmal vorkommen darf?
		\begin{multicols}{3}
		\doublespacing
...
\item 4 Kochbücher, 5 Physikbücher und 6 Chemiebücher sollen auf einem Regal nebeneinander gestellt werden. Auf wie viele Arten kann man das tun, wenn Bücher des gleichen Stoffgebietes nebeneinander gestellt werden sollen und alle Bücher verschieden sind?
		\begin{multicols}{3}
		\doublespacing
...
\subsection{Bestimmen Sie alle Lösungen der folgenden Ungleichung:}
