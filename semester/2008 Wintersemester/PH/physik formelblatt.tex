...
\item \underbar{Fluﬂ durch eine gerade Fl‰che}\\\\
$\Phi=\vec E\cdot \vec a = E \cdot a \cdot \cos \alpha$\\
\item \underbar{Fluﬂ durch eine gekr¸mmte Fl‰che}\\\\
$\Phi=\int \vec E\cdot \vec a$\\
\item \underbar{Fluﬂ durch eine Kugelfl‰che(Punktladung)}\\\\
...
da Q=0 E=0\\
\item \underbar{Feld einer Isolatorkugel(auﬂen)}\\\\
s. leitende Kugel auﬂen\\
...
\item \underbar{Fluﬂ durch einen gerade Leiter}\\\\
