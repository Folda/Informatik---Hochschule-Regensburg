...
\node[state,fill=white] at (2,2.5) (m1s) {};
\node[state,fill=white] at (2,-1.5) (m2s) {};

\node[state,accepting,fill=white] at (4,3.5) {};
\node[state,accepting,fill=white] at (4,1.5) {};

\node[state,accepting,fill=white] at (4,-0.5) {};
\node[state,accepting,fill=white] at (4,-2.5) {};
...
\subsection{GI-26.05.2009-IMG-10}
...
\section{27.05.2009}
\subsection{GI-27.05.2009-IMG-1}
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=2.8cm,semithick]
\node[state, initial, initial text=] (q0) {$q_0$};
...
\subsection{GI-16.06.2009-IMG-2}
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=2.8cm,semithick]
